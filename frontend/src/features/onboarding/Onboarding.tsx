...
export default function Onboarding() {
  ...
  const saveConfig = useMutation({
    ...
    onSuccess: () => {
      ...
      completeOnboarding() // Marcar onboarding como completado en el store
  ...
  // Modelos de transcripción Whisper - Actualizado Enero 2026
  const whisperModels = [
  ...
  // Modelos LLM - Actualizado Enero 2026
